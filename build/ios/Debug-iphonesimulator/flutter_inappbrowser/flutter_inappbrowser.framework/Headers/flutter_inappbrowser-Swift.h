...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="flutter_inappbrowser",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@class UIView;

SWIFT_CLASS("_TtC20flutter_inappbrowser24FlutterWebViewController")
...
SWIFT_CLASS("_TtC20flutter_inappbrowser21FlutterWebViewFactory")
...
SWIFT_CLASS("_TtC20flutter_inappbrowser7Options")
...
SWIFT_CLASS("_TtC20flutter_inappbrowser19InAppBrowserOptions")
@interface InAppBrowserOptions : Options
@end
...
SWIFT_CLASS("_TtC20flutter_inappbrowser12InAppWebView")
@interface InAppWebView : WKWebView <UIScrollViewDelegate, WKNavigationDelegate, WKScriptMessageHandler, WKUIDelegate>
...
SWIFT_CLASS("_TtC20flutter_inappbrowser19InAppWebViewOptions")
@interface InAppWebViewOptions : Options
@end



SWIFT_CLASS("_TtC20flutter_inappbrowser20SafariBrowserOptions")
@interface SafariBrowserOptions : Options
@end

@protocol FlutterPluginRegistrar;
@class FlutterMethodCall;

SWIFT_CLASS("_TtC20flutter_inappbrowser18SwiftFlutterPlugin")
